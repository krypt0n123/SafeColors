...
function HashNode({ id, data }: NodeProps<Node<NodeData>>) {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200 min-w-[625px]">
      <Handle
        id="b-top"
        type="target"
      ...
      />
      <div className="text-base font-medium text-gray-700 mb-2">Sha256 Hash:</div>
